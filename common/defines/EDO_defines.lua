...
NDefines.NGame.END_DATE = "1930.1.1.1"
...
NDefines.NMilitary.LAND_SPEED_MODIFIER = 0.1

NDefines.NSupply.CAPITAL_SUPPLY_BASE = 5 -- base supply for capital
NDefines.NSupply.CAPITAL_INITIAL_SUPPLY_FLOW = 4.0 -- starting supply from capital
...
NDefines.NSupply.CAPITAL_ADDED_PENALTY_PER_PROVINCE = 0.2 -- added penalty as we move away from origin
...
NDefines.NSupply.NAVAL_BASE_STARTING_PENALTY_PER_PROVINCE = 0.2
NDefines.NSupply.NAVAL_BASE_ADDED_PENALTY_PER_PROVINCE = 0.2
